...
const API_HEADERS = {
    ...
    'Authorization': 'any-string-you-like' // 로컬 서버의 경우 권한 부여가 없다.
};
...
class KanbanBoardContainer extends Component {
    ...
    deleteTask(cardId, taskId, taskIndex) {
        ...
        let nextState = update(this.state.cards, {
            [cardIndex]: {
                tasks: {$splice: [[taskIndex,1]] } // tasks중에서 해당 인덱스 splice로 삭제
            }
        });
